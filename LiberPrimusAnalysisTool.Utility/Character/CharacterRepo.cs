...
namespace LiberPrimusAnalysisTool.Utility.Character
{
    ...
    public class CharacterRepo : ICharacterRepo
    {
        ...
        public CharacterRepo()
        {
            ...
            _asciiAnsiItems.Add(new Tuple<string, string, int, string>("ASCII", "<LF>", 10, "0001010"));
            ...
            _asciiAnsiItems.Add(new Tuple<string, string, int, string>("ASCII", "<CR>", 13, "0001101"));
            ...
            _asciiAnsiItems.Add(new Tuple<string, string, int, string>("ANSI", "<LF>", 10, "00001010"));
            ...
            _asciiAnsiItems.Add(new Tuple<string, string, int, string>("ANSI", "<CR>", 13, "00001101"));
